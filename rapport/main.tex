...
% En-tête
\lhead{\textbf{\color{burgundy}CHPS0801 : Modèles de programmation parallèle}} % En-tête à gauche
\rhead{\textbf{\color{burgundy}M1 CHPS}} % En-tête à droite

% Pied de page
\lfoot{\textbf{\color{burgundy}Despoullains, Marano}} % Pied de page à gauche
...
\author{Romain Despoullains \and Nicolas Marano}
...
\begin{titlepage}
    ...
    \begin{minipage}{0.6\textwidth}
        \centering
        \begin{tabular}{r l}
            \textbf{Auteurs} & : Romain Despoullains \\
                             & Nicolas Marano \\
        \end{tabular}
    \end{minipage}
    ...
    {\footnotesize \textcolor{gray}{CHPS0801 : Modèles de programmation parallèle}}\\[0.2cm]
...
\input{chapters/parallelisation_kokkos_gpu}

% Chapitre 8 : Extensions algorithmiques (symétries, backtracking, parallel attempts)
\input{chapters/extensions_algorithmiques}
