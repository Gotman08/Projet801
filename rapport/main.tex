...
% When the user has saved the PNG into results/figures/schemas/, they
% replace the call site with \includegraphics{results/figures/schemas/foo.png}.
\newcommand{\schemaImage}[1]{%
  \fbox{\parbox{0.85\textwidth}{\centering\small\itshape%
    [Schema PNG to be generated via ChatGPT\\%
    (prompt in \texttt{schemas/} folder).]\\[1ex]%
    \textbf{Sujet du schema :} #1}}%
}
