...
\subsection{Visualisation des samples d'entrée}

Les samples sont des grilles d'entiers de taille modeste rendues
ci-dessous en images PNG (un pixel par cellule, palette couleur par
valeur). Le solveur n'a accès qu'à cette grille brute ; la palette
n'est qu'un aide visuel pour le lecteur.

\begin{figure}[H]
\centering
\begin{subfigure}[t]{0.18\linewidth}
\centering
\includegraphics[width=\linewidth]{results/figures/results/inputs/binary_5x5_input.png}
\caption{binary\_5x5}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.18\linewidth}
\centering
\includegraphics[width=\linewidth]{results/figures/results/inputs/binary_stripes_input.png}
\caption{stripes}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.18\linewidth}
\centering
\includegraphics[width=\linewidth]{results/figures/results/inputs/binary_dots_input.png}
\caption{dots}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.18\linewidth}
\centering
\includegraphics[width=\linewidth]{results/figures/results/inputs/binary_checker_input.png}
\caption{checker}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.18\linewidth}
\centering
...
\caption{Samples binaires utilisés. \texttt{binary\_5x5} est l'exemple
littéral du sujet ; les autres testent des cas dégénérés (stripes,
checker) ou esthétiques (dots, rooms).}
\label{fig:inputs_binary}
\end{figure}
...
\centering
\includegraphics[width=\linewidth]{results/figures/results/inputs/multivalue_terrain_input.png}
\caption{terrain (4 valeurs).}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.31\linewidth}
\centering
\includegraphics[width=\linewidth]{results/figures/results/inputs/multivalue_maze_input.png}
\caption{maze (3 valeurs).}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.31\linewidth}
\centering
\includegraphics[width=\linewidth]{results/figures/results/inputs/multivalue_smooth_input.png}
\caption{smooth (4 valeurs).}
\end{subfigure}

\caption{Samples multi-valeurs. \texttt{terrain} (eau/sable/herbe/roche),
\texttt{maze} (sol/mur/porte), \texttt{smooth} (gradients lisses).}
\label{fig:inputs_multivalue}
\end{figure}
...
\caption{Samples gallery utilisés au Chapitre~\ref{chap:resultats}
pour la galerie qualitative.}
\label{fig:inputs_gallery}
\end{figure}
...
\bottomrule
\end{tabularx}
\caption{Scripts SLURM Romeo livrés avec le projet.}
...
success, attempts, collapses, propagations, rules_s, solve_s, total_s
\end{verbatim}
...
\bottomrule
\end{tabularx}
\caption{Jobs SLURM utilisés pour le rapport. CSV combiné dans \texttt{results/all\_combined.csv} (398 lignes).}
