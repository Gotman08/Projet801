...
Voir \texttt{schemas/overlap\_compatibility.md} pour le prompt de génération.\\
Diagramme d'overlap pour $N = 2$ : deux tuiles $2 \times 2$ partageant une zone de $1 \times 2$ à l'offset $(1, 0)$, avec encadrement de la condition de compatibilité.
}}
