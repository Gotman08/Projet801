...
Amdahl binary\_L11 128×128 \textbf{après} activation de l'optim
frontier-threshold. $f$ passe de 0.928 à 0.956, ceiling de
...
\caption[Backends sur terrain et smooth pour 3 tailles.]{Backends
sur \texttt{terrain\_L33} et \texttt{smooth\_N3}, 3 tailles. Sur
smooth\_N3, Kokkos suit serial très près à toutes les tailles : peu
de parallélisme exploitable. Sur terrain\_L33, Kokkos bénéficie
davantage de la parallélisation à mesure que la grille grandit.}
